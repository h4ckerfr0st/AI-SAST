...
public class VulnerableController {
    ...
    @GetMapping(value="/vuln4", produces = MediaType.TEXT_HTML_VALUE)
    public String vuln(@RequestParam(required=false, defaultValue="guest") String name,
        ...
        try {
            ...
            stmt.execute("CREATE TABLE IF NOT EXISTS accounts(id INT PRIMARY KEY, username VARCHAR(255))");
            stmt.execute("MERGE INTO accounts(id, username) KEY(id) VALUES(1,'alice')");
