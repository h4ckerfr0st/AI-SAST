...
public class VulnerableController {
    ...
    @GetMapping(value="/vuln5", produces = MediaType.TEXT_HTML_VALUE)
    public String vuln(@RequestParam(required=false, defaultValue="guest") String name,
        ...
        try {
            ...
            stmt.execute("CREATE TABLE IF NOT EXISTS people(id INT PRIMARY KEY, username VARCHAR(255))");
            stmt.execute("MERGE INTO people(id, username) KEY(id) VALUES(1,'alice')");

            String query = "SELECT username FROM people WHERE id = " + id;
