...
public class VulnerableController {
    ...
    @GetMapping(value="/vuln2", produces = MediaType.TEXT_HTML_VALUE)
    public String vuln(@RequestParam(required=false, defaultValue="guest") String name,
        ...
        try {
            ...
            stmt.execute("CREATE TABLE IF NOT EXISTS members(id INT PRIMARY KEY, username VARCHAR(255))");
            stmt.execute("MERGE INTO members(id, username) KEY(id) VALUES(1,'alice')");

            String query = "SELECT username FROM members WHERE id = " + id;
